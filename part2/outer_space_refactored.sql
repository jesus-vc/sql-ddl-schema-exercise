...
(
  ...
  orbits_around INTEGER NOT NULL REFERENCES stars(id) ON DELETE SET NULL,
  galaxy INTEGER NOT NULL REFERENCES galaxies(id) ON DELETE SET NULL,
  moons TEXT[]
);
